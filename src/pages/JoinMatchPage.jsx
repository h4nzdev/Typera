...
const JoinMatchPage = () => {
  ...
  const handleJoin = (e) => {
    ...
    if (!challengerName.trim()) { setError('ENTER YOUR PLAYER NAME'); return; }
    setError('');
      ...
      <div className="jp-panel z-10 w-full max-w-md px-4">
        <PixelPanel color="#ff007f">
          ...
          <form onSubmit={handleJoin} className="flex flex-col items-center gap-5">
            ...
            <div className="w-full flex flex-col items-center gap-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  className="bg-black border-2 border-[var(--color-neon-pink)] px-6 py-3 text-center font-[family-name:var(--font-arcade)] text-3xl tracking-[0.4em] pl-[calc(0.4em+16px)] text-[var(--color-neon-pink)] outline-none uppercase w-[280px]"
            ...
            <div className="w-full flex flex-col items-center gap-2 border-t-2 pt-4" style={{ borderColor: 'rgba(255,0,127,0.2)' }}>
              <span className="font-[family-name:var(--font-arcade)] text-xs tracking-widest text-pink-300">ENTER YOUR NAME</span>
              <input
                type="text"
                maxLength={5}
                ...
                placeholder="PLAYER"
                className="w-full bg-black border-2 border-[var(--color-neon-pink)] px-4 py-2 text-center font-[family-name:var(--font-arcade)] text-2xl tracking-widest text-pink-300 outline-none uppercase"
                style={{ boxShadow: '0 0 15px rgba(255,0,127,0.2)' }}
              />
            </div>
            ...
            <div className="flex flex-col gap-3 w-full border-t-2 pt-4" style={{ borderColor: 'rgba(255,0,127,0.2)' }}>
              <ArcadeButton type="submit" color="pink" className="w-full py-3" onClick={handleJoin}>
                JOIN MATCH LOBBY
              </ArcadeButton>
